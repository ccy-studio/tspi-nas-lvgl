 ...
 * @param font 字体
 */
void set_label_style(lv_obj_t * label, lv_color_t color, int32_t x, int32_t y, const lv_font_t * font)
{
...
void get_current_datetime(datetime_t * current_time)
{
    ...
    static struct tm * time_info = NULL;
    ...
    current_time->year   = time_info->tm_year + 1900; // tm_year表示自1900年以来的年数
    current_time->month  = time_info->tm_mon + 1;     // tm_mon表示月份，从0开始
    current_time->day    = time_info->tm_mday;

    // 设置星期字符串
    switch(current_time->week) {
        case 0: current_time->week_str = "星期日"; break;
        case 1: current_time->week_str = "星期一"; break;
        case 2: current_time->week_str = "星期二"; break;
        case 3: current_time->week_str = "星期三"; break;
        case 4: current_time->week_str = "星期四"; break;
        case 5: current_time->week_str = "星期五"; break;
