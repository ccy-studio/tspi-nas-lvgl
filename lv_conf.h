...
({ \
    ...
    ((delta * dividend + (divisor / 2)) / divisor + (out_min)); \
})
 ...
 * - LV_OS_WINDOWS
 * - LV_OS_CUSTOM */
#define LV_USE_OS   LV_OS_PTHREAD   //使用Linux内的pthread库
...
#define LV_USE_SYSMON   1  //调试开启显示系统监视器
#if LV_USE_SYSMON
...
/*Driver for /dev/fb*/
#define LV_USE_LINUX_FBDEV      1  //启用FB支持
...
#define LV_USE_EVDEV    1 //启用对Linux输入子系统（evdev）的支持
